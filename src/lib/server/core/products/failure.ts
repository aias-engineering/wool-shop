...
export const ProductInfoNotPresent = (productId: string, locale: string): ProductInfoNotPresent => ({
  type: "failure",
  code: "cpr-05",
...
export const isProductInfoNotPresent = (x: unknown): x is ProductInfoNotPresent => {
